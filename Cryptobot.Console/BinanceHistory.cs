...
public static class BinanceHistory
{
    ...
    private const string _resourcesDir = @"C:\Users\stath\Documents\Coding\Darwin\DarwinAlgo\DarwinAlgo\Binance\Resources\";
    ...
    private static Candlestick[] ReadRawData(string[] rows)
    {
        return rows
            .Select(x => x.Split(',', StringSplitOptions.RemoveEmptyEntries) is string[] arr ? new Candlestick()
            {
